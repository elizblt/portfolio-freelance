...
/**
 * Section Contact. Un formulaire simple qui affiche une alerte après envoi.
 */
      ...
      <form onSubmit={handleSubmit} className="max-w-2xl mx-auto space-y-6">
        <div className="flex flex-col">
          ...
          <input
            ...
            required
            className="p-3 rounded-md border border-blue-100 bg-white/70 backdrop-blur-md text-[#111] focus:outline-none focus:ring-2 focus:ring-blue-300"
          />
        </div>
        <div className="flex flex-col">
        ...
        <button type="submit" className="inline-block bg-blue-600 text-white px-8 py-3 rounded-full font-medium hover:bg-blue-700 transition">
          Envoyer le message
        </button>
      </form>
    </section>
