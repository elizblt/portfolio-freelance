...
export default function Services() {
  return (
    <section id="services" className="py-24 px-6 md:px-20 text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        {services.map((service, i) => (
          <div key={i} className="bg-white/70 backdrop-blur-lg rounded-xl p-8 shadow-lg hover:shadow-xl transition text-left border border-blue-100">
            <div className="mb-4 text-blue-600">{service.icon}</div>
            <h3 className="text-xl font-semibold mb-2 text-[#111]">{service.title}</h3>
