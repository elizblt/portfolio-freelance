      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {projects.map((p, i) => (
            <motion.article
              ...
              className="group relative overflow-hidden rounded-3xl bg-white ring-1 ring-gray-200 shadow-sm transition-all duration-300 hover:shadow-xl"
            >
              {/* Image bloc – cadre incliné, constant comme sur le hero */}
              <div className="p-4">
                <div className="relative -rotate-3 aspect-[3/4] w-full rounded-[26px] border-4 border-white ring-1 ring-black/5 shadow-2xl overflow-hidden">
                  {/* halo discret derrière */}
                  <div className="absolute inset-0 -z-10 rounded-[26px] blur-xl bg-gradient-to-br from-gray-300/35 to-gray-200/20" />
              ...
              <div className="px-6 pb-6">
                <div className="flex items-center gap-2 text-xs text-gray-600">
                  <span className="inline-flex items-center rounded-full ring-1 ring-gray-200 px-2 py-1 bg-gray-50">
                    {p.type}
                  </span>
                ...
                <div className="mt-4 grid grid-cols-3 gap-2">
                  {p.metrics.map((m) => (
                    <div
                      key={m.label}
                      className="rounded-xl bg-gray-50 ring-1 ring-gray-200 px-3 py-2 text-center"
                    >
                ...
                <div className="mt-5">
                  <Link
                    ...
                    className="inline-flex items-center gap-1.5 rounded-full px-3 py-2 text-sm font-semibold
                               text-gray-900 ring-1 ring-gray-200 hover:bg-gray-50 hover:ring-gray-300 transition"
        ...
        >
          <div className="rounded-2xl border border-gray-100 bg-white/70 px-6 py-8 shadow-[0_8px_30px_rgba(0,0,0,0.04)]">
            <h3 className="text-xl font-semibold text-gray-900">Vous avez un projet ?</h3>
            <p className="mt-2 text-gray-600 max-w-xl mx-auto">
              Parlons objectifs, délais et budget. Une première réponse sous 24&nbsp;h.
            </p>
            <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 rounded-full
                           ...
                           ring-1 ring-gray-200 hover:bg-gray-50 hover:ring-gray-300 transition"
              >
                Voir les services
              </Link>
            </div>
